...
class InfluxdbConnector(BaseConnector):
    ...
    def _process_html_response(self, response, action_result):
        ...
        # Handle valid responses from influxdb
        if (status_code == 204):
    ...
    def _handle_run_query(self, param):
        ...
        # make rest call
        ret_val, response = self._make_rest_call('/query', action_result, params=param, headers=None)
        # ret_val, response = self._make_rest_call('/query?q=show+databases', action_result, params=None, headers=None)
        ...
        response_dict = {"results": response["results"]}
    ...
    def handle_action(self, param):
        ...
        if action_id == 'test_connectivity':
            ...
            # self.debug_print("Parameters: ", param)
